  ...
  return (
    <div className="min-h-screen flex flex-col font-sans text-slate-900 bg-white">
      ...
      <main className="flex-grow ">
        ...
        */}
        <ScrollReveal animation="fadeInUp"><StaircaseCourseCards /></ScrollReveal>

        {/* 
          ADDITIONAL INFO / CTA
        */}
        <section className="pb-24 bg-white border-t border-orange-100 relative">
            <ScrollReveal animation="fadeInUp"><FAQSection /></ScrollReveal>
          <ScrollReveal animation="popIn" className="container mx-auto px-4 relative z-10">

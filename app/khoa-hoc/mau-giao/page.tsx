...
export default function PreschoolEnglishPage() {
   ...
   return (
      ...
      `}} />
                  ...
                  <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                     ...
                     <div className="text-white space-y-6 lg:space-y-5 animate-in fade-in slide-in-from-bottom-8 duration-700 text-center lg:text-left order-2 lg:order-1">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center lg:justify-start w-full sm:w-auto">
                           <Button size="lg" className="bg-white text-orange-600 hover:bg-orange-50 hover:text-orange-700 font-bold px-8 lg:px-10 h-14  rounded-full shadow-2xl shadow-orange-900/20 transition-transform hover:-translate-y-1 w-full sm:w-auto" asChild>
        ...
        */}
            <section className="relative -mt-16 lg:-mt-8 z-30 pb-16 lg:pb-20 ">

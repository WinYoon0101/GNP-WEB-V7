...
export function LearningMethods() {
  return (
    <section className="py-20 md:py-32 bg-white relative overflow-hidden font-sans">
      {/* Background Decor (Đổi sang tông cam nhạt trên nền trắng) */}
      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        <div className="text-center mb-2 relative z-10 px-4">
          <motion.h2
            ...
            className="text-3xl md:text-5xl font-extrabold text-[#F2701A] mb-6 tracking-tight md:translate-y-[120px]"
          >
            Phương Pháp{" "}
        ...
        <div className="hidden lg:flex relative w-full h-[900px] items-center justify-center mt-[-40px]">
          {/* Concentric Rings (Đổi sang viền cam mờ để nổi bật trên nền trắng) */}
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[840px] h-[840px] rounded-full border border-[#F2701A]/20 z-0" />
          ...
          <motion.div
            ...
            className="relative z-10 w-[240px] h-[240px] rounded-full overflow-hidden border-[10px] border-white shadow-[0_15px_40px_rgba(242,112,26,0.2)] flex items-center justify-center bg-[#F2701A]"
          >
            ...
            return (
              ...
              >
                ...
                <div className="absolute top-0 left-0 -translate-x-1/2 -translate-y-[32px] w-[260px] flex flex-col items-center">
                  {/* Icon Circle */}
                  <div className="mb-4 relative w-16 h-16 rounded-full bg-slate-50 border border-slate-100 flex items-center justify-center shadow-[0_8px_25px_rgba(242,112,26,0.08)] group-hover:shadow-[0_8px_30px_rgba(242,112,26,0.2)] transition-all duration-300 z-10 overflow-hidden group-hover:-translate-y-1.5">
                  ...
                  <div className="text-center relative">
                    <h3 className="font-bold text-[15.5px] mb-2 text-[#F2701A] group-hover:text-[#ff8533] transition-colors">
                      {method.title}
                    </h3>
                    <p className="text-slate-600 text-[13.5px] leading-relaxed px-2">
                      {method.description}
                    </p>
                  </div>
                </div>
        ...
        <div className="lg:hidden grid grid-cols-1 sm:grid-cols-2 gap-5 max-w-3xl mx-auto mt-8 relative z-10 px-2">
          {methods.map((method, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white rounded-2xl p-5 border border-slate-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_10px_30px_rgba(242,112,26,0.1)] hover:border-[#F2701A]/20 transition-all flex items-start gap-4 group cursor-pointer overflow-hidden relative"
            >
              ...
              <div className="w-14 h-14 shrink-0 rounded-full bg-slate-50 group-hover:bg-[#F2701A] flex items-center justify-center transition-colors duration-300 border border-slate-100 group-hover:border-transparent">
                <method.icon className="w-[26px] h-[26px] text-[#F2701A] group-hover:text-white transition-colors duration-300 stroke-[2]" />
              </div>
              <div className="flex-1 mt-0.5">
                <h3 className="font-bold text-[16px] mb-1.5 text-[#F2701A] transition-colors">
                  {method.title}
                </h3>

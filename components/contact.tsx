...
import { Phone, Mail, MapPin, Clock, Send, CheckCircle2, Star, Sparkles, Navigation } from "lucide-react"
...
export function Contact() {
  ...
  return (
    <section id="dang-ky-tu-van" className="relative py-20 lg:py-32 overflow-hidden bg-[#F8FAFC]">
      ...
      <div className="container mx-auto px-4 relative z-10 max-w-7xl">
        ...
        <div className="mx-auto mb-12 lg:mb-20 max-w-3xl text-center">
          ...
          <p className="text-pretty text-lg text-slate-600 font-medium">
            Đăng ký tư vấn học tập và trải nghiệm phương pháp giáo dục hiện đại tại GNP ngay hôm nay!
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className={`lg:col-span-5 w-full transition-all duration-700 transform ${!mounted ? 'opacity-0 translate-y-12' : 'opacity-100 translate-y-0'}`}>
            <Card className="border-0 shadow-[0_20px_50px_rgba(0,0,0,0.06)] overflow-hidden rounded-[2rem] bg-white relative">
              ...
              <div className="p-8 lg:p-10">
                <div className="mb-8">
                  <h3 className="text-2xl font-black text-slate-800 mb-2">Đăng ký tư vấn</h3>
                  <p className="text-slate-500 font-medium text-sm">Điền thông tin và chúng tôi sẽ gọi lại cho bạn trong 24h.</p>
                </div>
                ...
                {isSuccess ? (
                  <div className="bg-green-50 border border-green-200 rounded-2xl p-8 text-center flex flex-col items-center justify-center animate-in fade-in duration-500 min-h-[400px]">
                    ...
                    <p className="text-green-600 text-sm font-medium">Cảm ơn bạn đã quan tâm. Đội ngũ tư vấn viên sẽ liên hệ với bạn trong thời gian sớm nhất.</p>
                  </div>
                ) : (
                  <form onSubmit={handleSubmit} className="space-y-5 animate-in fade-in duration-500">
                    ...
                    <div className="space-y-1.5">
                      <Label htmlFor="course" className="text-sm font-bold text-slate-700">Khóa học quan tâm</Label>
                      <Input
                        id="course"
                    ...
                    <div className="space-y-1.5">
                      <Label htmlFor="message" className="text-sm font-bold text-slate-700">Lời nhắn</Label>
                      <Textarea
                        id="message"
          ...
          <div className={`lg:col-span-7 w-full transition-all duration-700 delay-150 transform ${!mounted ? 'opacity-0 translate-y-12' : 'opacity-100 translate-y-0'}`}>
            <Card className="border-0 shadow-2xl overflow-hidden rounded-[2rem] bg-[#1E3A8A] text-white flex flex-col h-full relative">
              {/* Abstract decorative graphic inside the blue card */}
              <div className="absolute top-0 right-0 p-8 opacity-10 pointer-events-none">
                <svg width="200" height="200" viewBox="0 0 100 100" className="animate-[spin_40s_linear_infinite]">
              ...
              <div className="p-8 lg:p-10 flex-shrink-0 relative z-10">
                <h3 className="text-2xl lg:text-3xl font-black mb-8">Thông tin liên hệ</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-sky-200 text-sm font-semibold mb-1 uppercase tracking-wider">Hotline</p>
                      <p className="font-bold text-lg md:text-xl tracking-tight">0286.286.2934</p>
                      <p className="font-bold text-lg md:text-xl tracking-tight">0286.286.2931</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-sky-200 text-sm font-semibold mb-1 uppercase tracking-wider">Email</p>
                      <p className="font-medium text-base break-all">info@gnpenglish.edu.vn</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 md:col-span-2">
                    ...
                    <div>
                      <p className="text-sky-200 text-sm font-semibold mb-1 uppercase tracking-wider">Giờ làm việc</p>
                      <p className="font-medium text-base">Thứ 2 - Thứ 7: <span className="font-bold text-orange-400">8:00 - 20:00</span></p>
                      <p className="font-medium text-base">Chủ nhật: <span className="font-bold text-orange-400">8:00 - 17:00</span></p>
                    </div>
                  </div>
                </div>
                ...
                <div className="pt-6 border-t border-white/10">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <p className="text-sky-200 text-sm font-semibold uppercase tracking-wider">Hệ thống chi nhánh</p>
                  </div>
                  ...
                  <div className="mt-4 flex items-center gap-2 text-white/90 font-medium bg-black/20 p-3 rounded-xl border border-white/5">
                    ...
                    <span className="text-sm md:text-base">{branches[selectedBranch].address}</span>
                  </div>
                </div>
              </div>

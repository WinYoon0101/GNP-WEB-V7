...
const DEFAULT_GLOW_COLOR = "242, 112, 26";
...
const cardData: BentoCardProps[] = [
  {
    ...
    description:
      "Giảng dạy tương tác, phát triển toàn diện 4 kỹ năng ngoại ngữ.",
    label: "Tương tác",
    image: "/TA_3.jpg",
  },
  {
    ...
    description:
      "Xây dựng theo các bộ giáo trình uy tín, chuẩn hóa theo từng mục tiêu.",
    label: "Chất lượng",
    image: "/giaotrinh.png",
  },
  {
    ...
    description: "Đội ngũ chuyên môn cao, tận tâm đồng hành cùng người học.",
    label: "Tận tâm",
    image: "/banner.jpg",
  },
  
   {
    ...
    description:
      "Phòng học trang bị đầy đủ thiết bị, tạo không gian học tập thoải mái.",
    label: "Tiện nghi",
    image: "/cosovatchat.jpg",
  },
  {
    color: "#060010",
    title: "Lớp học quy mô nhỏ",
    description: "Số lượng học viên giới hạn để theo sát và hỗ trợ tốt nhất.",
    label: "Hiệu quả",
    image: "/TA_1.jpg",
  },
  {
    color: "#060010",
    title: "Kết quả học tập rõ ràng",
    description:
      "Cải thiện giao tiếp và nhanh chóng đạt mục tiêu tiếng Anh đề ra.",
    label: "Cam kết",
...
const MagicBento: React.FC<BentoProps> = ({
  ...
  return (
    <>
      <style>
        {`
          .bento-section {
            ...
            --border-color: #3f2f25;
            --background-dark: #120b06;
            --white: hsl(0, 0%, 100%);
            --purple-primary: rgba(242, 112, 26, 1);
            --purple-glow: rgba(242, 112, 26, 0.2);
            --purple-border: rgba(242, 112, 26, 0.8);
          }
      ...
      <div className="md:hidden w-full relative pb-8">
        <Carousel setApi={setApi} opts={{ align: "center", loop: false }} className="w-full">
          <CarouselContent className="-ml-4">
            {cardData.map((card, index) => (
              <CarouselItem key={index} className="pl-4 basis-full relative">
